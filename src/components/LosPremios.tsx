        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-neutral-600 dark:text-neutral-300 leading-relaxed text-justify">
              <p>
                A raíz del 35 aniversario del grupo scout Los Descalzos, nos motiva la idea
              ...
              <p>
                Los Premios Huella son unos premios creados por y para los scouts, pero sin olvidar el gran
              ...
              <p>
                ...
                ser votados durante la gala. Contacta con nosotros para comprar tus entradas. 
              </p>
            </div>
